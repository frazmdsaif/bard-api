...
public class PageCloneService {

    public static Response clonePage(String queryKey) {
        String endpoint = String.format("/api/v1/pms/explore-pages/%s/clone", queryKey);
    ...
    public static Response clonePageSimple(String queryKey) {
        String endpoint = String.format("/api/v1/pms/explore-pages/%s/clone", queryKey);
        return RestClient.post(endpoint, "");
    }

    public static String readPageCloneEndpoint(String queryKey) {
        String endpoint = String.format("/api/v1/pms/explore-pages/%s/clone", queryKey);
