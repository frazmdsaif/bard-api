...
public class SlugCloneService {

    public static Response cloneSlug(String slug) {
        String endpoint = String.format("/api/v1/pms/explore-pages/%s/clone", slug);
    ...
    public static Response cloneSlugSimple(String slug) {
        String endpoint = String.format("/api/v1/pms/explore-pages/%s/clone", slug);
        return RestClient.post(endpoint, "");
    }

    public static String readSlugCloneEndpoint(String slug) {
        String endpoint = String.format("/api/v1/pms/explore-pages/%s/clone", slug);
